...
class Character():
	...
	def stats_blit_(self,surface):
		...
		ab1_desc = fontS.render(str(self.abilities[0][5]), True, (65, 32, 96))
		ab2_desc = fontS.render(str(self.abilities[1][5]), True, (65, 32, 96))
		ab3_desc = fontS.render(str(self.abilities[2][5]), True, (65, 32, 96))
		ab4_desc = fontS.render(str(self.abilities[3][5]), True, (65, 32, 96))
		...
		if self.classc != "Assassin":
			surface.blit(ab1_desc, (width // 2.2, height // 1.65))
			surface.blit(ab2_desc, (width // 2.2, height // 1.515))
			surface.blit(ab3_desc, (width // 2.2, height // 1.4))
			surface.blit(ab4_desc, (width // 2.2, height // 1.3))
		else:
			surface.blit(ab1_desc, (width // 2.1, height // 1.65))
			surface.blit(ab2_desc, (width // 2.1, height // 1.515))
			surface.blit(ab3_desc, (width // 2.1, height // 1.4))
			surface.blit(ab4_desc, (width // 2.1, height // 1.3))			
...
Valeria = Character(faction=1,image="Valeria.png",name="Valeria",fullname="Valeria Bloodthorn",classc="Assassin",hp=30, attack=50, defense=20, speed=40,
...
Damien = Character(faction=1,image="Damien.png",name="Damien",fullname="Damien Darkbane",classc="Cleric",hp=35, attack=60, defense=25, speed=30,
...
Draven = Character(faction=1,image="Draven.png",name="Draven",fullname="Draven Bloodthorn",classc="Warrior",hp=50, attack=55, defense=70, speed=15,
...
Lilith = Character(faction=1,image="Lilith.png",name="Lilith",fullname="Lilith Shadowfire",classc="Mage",hp=35, attack=40, defense=30, speed=35,
...
Viktor = Character(faction=1,image="Viktor.png",name="Viktor",fullname="Viktor Blackthorn",classc="Paladin",hp=60, attack=50, defense=40, speed=30,
...
Luna = Character(faction=2,image="Luna.png",name="Luna",fullname="Luna Shadowbane",classc="Assassin",hp=30, attack=50, defense=15, speed=45,
Cdescr1="Lethal, cunning, and secretive, with a penchant for stealth", Cdescr2="and subterfuge.")
Seraphina = Character(faction=2,image="Seraphina.png",name="Seraphina",fullname="Seraphina Lightbringer",classc="Cleric",hp=35, attack=55, defense=30, speed=35,
Cdescr1="Devout, compassionate, and wise, with a strong connection", Cdescr2="to the divine and a healing touch.")
Magnus = Character(faction=2,image="Magnus.png",name="Magnus",fullname="Magnus Ironfoot",classc="Warrior",hp=55, attack=50, defense=60, speed=20,
Cdescr1="Brave, honorable, and skilled in combat, always ready to defend", Cdescr2="their allies and uphold justice.")
Aurora = Character(faction=2,image="Aurora.png",name="Aurora",fullname="Aurora Starweaver",classc="Mage",hp=30, attack=45, defense=30, speed=30,
Cdescr1="Knowledgeable, arcane, and mysterious, with mastery over spells", Cdescr2="and the elements.")
Alistair = Character(faction=2,image="Alistair.png",name="Alistair",fullname="Alistair Dawnhammer",classc="Paladin",hp=65, attack=40, defense=45, speed=25,
